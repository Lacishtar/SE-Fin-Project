create database PhoneDistribute
...
insert into order_product(agentId,orderDate,statusOrder,statusPay,methodPay) 
	values(1,'2021-05-3',0,1,'Momo'),(1,'2021-06-3',0,1,'Zalo Pay'),(1,'2021-07-4',1,0,'Cash'),
			(2,'2021-08-3',0,0,'Zalo Pay'),(2,'2021-11-3',1,1,'Cash'),(3,'2022-02-3',1,0,'Zalo Pay'),
...
insert into order_detail(orderId ,productId,quantity)
	values (1,2,2),(1,1,4),(1,4,5),(1,5,7),(1,7,3),
			...
			(9,8,4),(9,3,2),(9,1,3),(9,10,4),(9,4,30)
